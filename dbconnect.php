<?php
    ...
    $username = "passfymail"; // Имя пользователя БД
    $password = "jaCa62hAs"; // Пароль пользователя. Если у пользователя нету пароля то, оставляем пустое значение ""
    $database = "passfymail"; // Имя базы данных, которую создали
    ...
    $address_site = "http://passfymail.temp.swtest.ru";
?>